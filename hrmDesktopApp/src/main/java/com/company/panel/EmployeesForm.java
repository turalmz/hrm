...
public class EmployeesForm extends javax.swing.JFrame {
     ...
     */
    private final EmployeesServiceInter employeeDao = HrmDesktopAppApplication.employeeService;
    ...
    private void generateEmployees() {
        ...
        for (com.company.entity.Employees us : users) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        for (int row : tblUsers.getSelectedRows()) {
            ...
            employeeDao.removeEmployees(Integer.parseInt(value));
