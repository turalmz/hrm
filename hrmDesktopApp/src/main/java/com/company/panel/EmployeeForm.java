...
public class EmployeeForm extends javax.swing.JFrame {
    ...
    private CountryServiceInter countryDao = HrmDesktopAppApplication.countryService;

    public EmployeeForm() {
        initComponents();
        currentEmployee = new Employees(null);
        Config.curUser = new Employees(null);
    ...
    public EmployeeForm(int i) {
        ...
        Config.curUser = employeeDao.getById(i);
        fillEmployeeComponent();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    private void fillEmployeeComponent() {
        ...
        try {
            Date dt = (Date) currentEmployee.getHireDate();
        ...
        try {
            txtAddress.setText(currentEmployee.getJobId().getJobTitle());
        } catch (Exception ex) {
            System.err.println(ex);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        currentEmployee.setSalary(BigDecimal.ZERO);
        currentEmployee.setCommissionPct(BigDecimal.ZERO);
        ...
        if (currentEmployee.getId() != null) {
            employeeDao.updateEmployees(currentEmployee);
        } else if (currentEmployee.getId() == null) {
            employeeDao.addEmployees(currentEmployee);
        }
    ...
    private javax.swing.JComboBox<Jobs> cbJob;
