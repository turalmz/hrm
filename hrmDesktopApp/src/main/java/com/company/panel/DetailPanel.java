...
public class DetailPanel extends javax.swing.JPanel {
     ...
     */
    //private CountryDaoInter countryDao = HrmDesktopAppApplication.employeeService;
    ...
    private void fillWindow() {
        ...
        for (com.company.entity.Countries con : HrmDesktopAppApplication.countryService.getAll()) {
    ...
    public void fillUserComponent() {
        ...
        try {
            Date dt = (Date) Config.loggedInUser.getHireDate();
        ...
        txtPhone.setText(Config.loggedInUser.getPhoneNumber());
        //txtAddress.setText(Config.loggedInUser.getAddress());
       // cbBirthplace.setSelectedItem(Config.loggedInUser.get());
       // cbNationality.setSelectedItem(Config.loggedInUser.getNationality());

    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<Countries> cbBirthplace;
    private javax.swing.JComboBox<Countries> cbNationality;
    ...
    public void fillUser(Employees usr) {
        try {
        ...
        usr.setPhoneNumber(txtPhone.getText());
